        ...
        ?>    
            ...
            <div class="latest-news__item swiper-slide">
                <div class="latest-news__item-inner row">
                    <div class="latest-news__image-col col-12 col-md-6 col-lg-7 col-xl-8">
                        <img src="<?php the_post_thumbnail_url( 'full' ); ?>" alt="" class="latest-news__thubnail rounded"  onclick="window.location.href='<?php the_permalink(); ?>';">
                    </div>
                    <div class="latest-news__text-col col-12 col-md-6 col-lg-5 col-xl-4">
                        <div class="latest-news__text post-item">
